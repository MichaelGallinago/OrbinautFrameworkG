...
public readonly struct SolidObjectData(OrbinautNode orbinautData, Constants.SolidType type, Vector2I extraSize)
{
    public readonly OrbinautNode Target = orbinautData;
