...
[Generator]
public sealed class FastEnumToStringGenerator : IIncrementalGenerator
{
    private const string AttributeName = nameof(FastEnumToStringAttribute);
    private const string FullAttributeName = $"{nameof(FastEnumToStringSourceGenerator)}.{AttributeName}";
    ...
    private static (bool, string, string?) GetArguments(ISymbol enumType, AttributeData attribute)
    {
        (bool isPublic, string className, string? @namespace) result = 
            (IsVisibleOutsideOfAssembly(enumType), $"{enumType.Name}FastToString", null);
...
"""
        ...
        sb.Append(
$$"""
    /// <summary>A class with generated allocation free ToString() alternative from enum.</summary>
    {{typeVisibility}} static partial class {{enumeration.ClassName}}
    {
        ...
        /// <returns><see cref="T:System.String">System.String</see>.</returns>
